      ...
      items: [
        {
          ...
          formula: "ocupadas_bin = max(0, ocupadas_bin_anterior + entradas_ocupada - salidas_ocupada)",
          pasos: [
            "Se define granularidad adaptativa: <= 2 dias = hora; <= 60 dias = dia; > 60 dias = mes.",
            "Se calcula ocupadas_inicio con el snapshot en desde.",
            "Cada evento del historial suma 1 si entra a OCUPADA y resta 1 si sale hacia VACIA, LIBRE o ALTA.",
            "Se recorre cada bin de tiempo acumulando el saldo operativo.",
