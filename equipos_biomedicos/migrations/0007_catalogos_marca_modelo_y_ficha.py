...
def migrar_catalogos_marca_modelo(apps, schema_editor):
    TipoDispositivo = apps.get_model("equipos_biomedicos", "TipoDispositivo")
    MarcaDispositivo = apps.get_model("equipos_biomedicos", "MarcaDispositivo")
    ModeloDispositivo = apps.get_model("equipos_biomedicos", "ModeloDispositivo")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("equipos_biomedicos", "0006_alter_asignaciondispositivo_table_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="equipos_biomedicos.marcadispositivo",
            ),
        ),
        migrations.AddField(
            model_name="dispositivo",
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.PROTECT,
                related_name="dispositivos",
                to="equipos_biomedicos.modelodispositivo",
            ),
        ),
